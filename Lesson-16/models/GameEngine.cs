...
namespace Mud2D.models
{
    public class GameEngine
    {
        ...
        public ObjectManager ObjectMgr { get; set; }
        ...
        public void StartLevel(int level)
        {
            ...
            MonsterMgr.AddMonsters(Tiles, randgen.Next(2, level + 3));

            ObjectMgr.AddObjects(Tiles, randgen.Next(3, level + 3));
        ...
        public MapTile GetRandomTileSpace()
        {
            ...
            var blanks = (from t in Tiles.Cast<MapTile>() where t.GetType() == typeof(MapTileSpace) && t.pickableObject == null select t).ToArray();
